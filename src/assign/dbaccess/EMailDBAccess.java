...
//Getting Connection using MS Access
	 ...
	 * // Getting Connection
	 * 
	 * // Getting Connection using Oracle // public static Connection
	 * getConnection() throws Exception{ // Connection dbConn = null; // try{ //
	 * Class.forName("oracle.jdbc.driver.OracleDriver"); // String url =
	 * "jdbc:oracle:thin:@servername:1521:dbname)"; // dbConn =
	 * DriverManager.getConnection(url, "userid","password"); // } // catch
	 * (SQLException sqle) { // sqle.printStackTrace(); // throw sqle; // } //
	 * catch(Exception e) { // e.printStackTrace(); // throw e; // } // return
	 * dbConn; // } // Connection Using MYSQL // public static Connection
	 * getConnection() throws Exception{ // Connection dbConn = null; // try{ //
	 * //step1: // Class.forName("com.mysql.jdbc.Driver"); // //step2 // String url
	 * = "jdbc:mysql://localhost:3306/test"; // //step3 // dbConn =
	 * DriverManager.getConnection(url, "root", "root"); // } // catch (SQLException
	 * sqle) { // sqle.printStackTrace(); // throw sqle; // } // catch(Exception e)
	 * { // e.printStackTrace(); // throw e; // } //return dbConn; //} //
	...
	public static void updateEMailAddress(EMailAddressVOO inEMailAddress) throws Exception{
	    ...
	    int rowsUpdated = 0;
	     ...
	     try{
		dbConn = getConnection();//emailaddress = ?,
